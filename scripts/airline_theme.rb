...
def generate_color_map(mode, a)
  b = $flamerial[:black_variant_2_bg].as_array()
  c = $flamerial[:black_variant_1_bg].as_array()
  "let g:airline#themes#flamerial#palette.#{mode} = airline#themes#generate_color_map(#{a}, #{b}, #{c})"
end

normal = $flamerial[:black_variant_3_bg].as_array()
visual = $flamerial[:blue_bg].as_array()
insert = $flamerial[:red_bg].as_array()
inactive = $flamerial[:black_variant_2_bg].as_array()
