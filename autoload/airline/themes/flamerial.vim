...
let s:airline_b_normal = [ "#f5cc7a" , "#744d34" , 7 , 5 ]
...
let s:airline_a_visual = [ "#170e05" , "#335c58" , 0 , 4 ]
let s:airline_b_visual = [ "#f5cc7a" , "#744d34" , 7 , 5 ]
...
let s:airline_b_insert = [ "#f5cc7a" , "#744d34" , 7 , 5 ]
